...
print(classification_report(testY.argmax(axis=1),
	...
	target_names=["Mbappe", "Messi", "Thiago"]))
...
plt.plot(np.arange(0, 100), H.history["val_loss"], label="Value_loss")
plt.plot(np.arange(0, 100), H.history["accuracy"], label="Training_accuracy")
plt.plot(np.arange(0, 100), H.history["val_accuracy"], label="Value_accuracy")
plt.title("Training Loss and Accuracy")
plt.xlabel("Epoch (one cycle)")
